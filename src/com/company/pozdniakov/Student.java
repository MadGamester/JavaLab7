...
public class Student {
        ...
        for(int i=0;i<this.subjects.length;i++){
            switch (i) {
                ...
                case 1: this.subjects[1] = new Subject(subject.BD);
                    break;
                case 2: this.subjects[2] = new Subject(subject.WebSecurity);
                    break;
                case 3: this.subjects[3] = new Subject(subject.SSU_LAN);
                    break;
                case 4: this.subjects[4] = new Subject(subject.ТППС);
                    break;
            }
        }
    ...
    public void passedSub(){
        for(int i=0;i<subjects.length;i++){
            System.out.println(this.subjects[i].getNameSubject() + ' ' + this.subjects[i].isPassed());
            System.out.println(this.subjects[i].getMark());
        }
    }
